...
func TestSyncListAddGet(t *testing.T)  {
...
func TestSyncListGetOutOfIndex(t *testing.T)  {
	list := collections.NewSyncArrayList()
	list.Add(1)
...
func TestSyncForeach(t *testing.T)  {
	list := collections.NewSyncArrayList()
	list.Add(1)
	list.Add(2)
	list.Add(3)
...
func TestSyncListJson(t *testing.T)  {
	list := collections.NewSyncArrayList()
	list.Add(1)

	list2 := collections.NewSyncArrayList()
	list.Add(list2)
	list2.Add(2)
	...
	aList := collections.NewSyncArrayList()
